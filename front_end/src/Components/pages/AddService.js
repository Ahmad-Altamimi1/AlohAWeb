...
export default function AddService() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const projectResponse = await axios.post("/projects/add", formData);
              ...
              <div className="row">
                      ...
                      <div className="wt-jobdescription wt-tabsinfo">
                        ...
                        <form
                          ...
                          <fieldset>
                            ...
                            <div
                              className="wt-jobskills wt-tabsinfo"
                              style={{
                                paddingTop: "50px",
                                marginBottom: "-10px",
                              }}>
                              ...
                              <div
                                className="form-group wt-btnarea "
                ...
                <div className="col-xs-12 col-sm-12 col-md-12 col-lg-8 col-xl-6 ">
                  <div className="wt-dashboardbox">
                    <div className="wt-dashboardboxtitle">
                      <div>
                        <h2 className="wt-tabscontenttitle">
                          Add Your Service and Start Earning
                        </h2>
                        <div
                          style={{ paddingLeft: "25px", paddingTop: "60px" }}>
                          <p>
                            On Freelancer, you have the opportunity to generate
                            income by adding services that you excel at and
                            making them available for sale to interested
                            customers. Please enter the service details
                            carefully so that the Freelancer team can review and
                            publish them.
                          </p>
                        </div>
                        <h2 className="wt-tabscontenttitle">
                          Tips for Adding a Valid Service
                        </h2>
                        <div
                          style={{ paddingLeft: "25px", paddingTop: "60px" }}>
                          <p>
                            <strong>Service Title</strong>: Choose a concise and
                            clear title that reflects precisely what you will
                            offer in your service, enabling buyers to find it
                            when searching for related keywords in your
                            service's field.
                          </p>

                          <p>
                            <strong>Service Description</strong>: Write a
                            distinctive description of the service in proper,
                            error-free language, explaining in detail what the
                            customer will receive when purchasing the service.
                          </p>

                          <p>
                            <strong>Service Gallery</strong>: Add an expressive
                            image related to the service, along with at least
                            three unique samples that introduce the buyer to
                            your work style and skills.
                          </p>

                          <p>
                            <strong>Service Price</strong>: Ensure that you set
                            an appropriate price for the service based on the
                            amount of work and effort involved, while
                            considering the site's commission. Also, specify a
                            suitable delivery time for completing the service
                            with quality.
                          </p>
                        </div>
                        <h2 className="wt-tabscontenttitle">
                          Why Services Get Rejected on Freelancer?
                        </h2>
                        <ul style={{ paddingLeft: "25px", paddingTop: "60px" }}>
                          <li>
                            A long, unclear title that merges multiple services
                            together.
                          </li>
                          <li>
                            Failure to specify the amount of work the buyer will
                            receive in the service description.
                          </li>
                          <li>
                            Low-quality images or designs not created by the
                            seller.
                          </li>
                          <li>
                            Attaching fewer than three samples to the service's
                            work gallery.
                          </li>
                          <li>
